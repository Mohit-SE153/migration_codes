        ...
        return [
            {
                ...
                "description": "Nightly load of SalesDW from source systems.",
                "date_created": "2024-01-01T02:00:00",
                "date_modified": "2024-06-01T02:00:00",
                "last_run_date": "2024-06-15",
                "last_run_time": "02:00:00",
                "last_run_status": "Succeeded",
                "last_outcome": "Succeeded",
                "next_scheduled_run": "2024-06-16T02:00:00",
                "step_count": 2,
                "schedule_names": ["Nightly 2AM"],
                "schedule_frequency": ["Daily"],
                "notification_operator": "DBA_Team",
                "notification_method": "On Failure",
                "retry_attempts": 3,
                "retry_interval": 5,
            },
            {
                ...
                "description": "Weekly index rebuild for SalesDW.",
                "date_created": "2024-01-01T03:00:00",
                "date_modified": "2024-01-01T03:00:00",
                "last_run_date": "2024-06-09",
                "last_run_time": "03:00:00",
                "last_run_status": "Succeeded",
                "last_outcome": "Succeeded",
                "next_scheduled_run": "2024-06-16T03:00:00",
                "step_count": 1,
                "schedule_names": ["Weekly Sunday 3AM"],
                "schedule_frequency": ["Weekly (interval=1)"],
                "retry_attempts": 0,
                "retry_interval": 0,
            },
        ]
