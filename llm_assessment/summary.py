...
AssessmentSummary. Fully self-contained independent copy (not imported
from assessment/summary.py) -- see schema.py's module docstring for why."""
from __future__ import annotations

from collections import Counter

from llm_assessment.config import LlmAssessmentConfig
from llm_assessment.schema import AssessmentSummary, MigrationWave, ObjectComplexity, RiskFinding
...
def build_summary(
    ...
    top_riskiest = [f"{oc.object_type}:{oc.name} (score={oc.complexity_score}, tier={oc.complexity_tier})"
