"""
Security/permissions migration considerations. Fully self-contained
independent copy (not imported from assessment/security_review.py) --
see schema.py's module docstring for why.
"""
from __future__ import annotations

from llm_assessment.schema import SecurityNote
