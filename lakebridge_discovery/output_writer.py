...
def write_csv_rollup(result: LakebridgeDiscoveryResult, output_dir: str, filename: str = "lakebridge_rollup.csv") -> Path:
    ...
    rows = [
        ...
        {"object_type": "database", "object_name": "(all)", "count": len(result.databases)},
        {"object_type": "database_file", "object_name": "(all)", "count": len(result.database_files)},
        {"object_type": "user_defined_type", "object_name": "(all)", "count": len(result.user_defined_types)},
        {"object_type": "xml_schema_collection", "object_name": "(all)", "count": len(result.xml_schema_collections)},
