...
AssessmentSummary -- the numbers an executive-summary reader wants without
...
from assessment.schema import AssessmentSummary, MigrationWave, ObjectComplexity, RiskFinding
